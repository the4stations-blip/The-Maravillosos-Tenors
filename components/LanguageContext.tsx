  ...
  es: {
    ...
    tenors: {
      ...
      profiles: {
        ...
        mario: {
          voice: "Tenor Ligero",
          bio: "Mario Méndez Saavedra es cantante y actor, con una sólida trayectoria en ópera, zarzuela, teatro musical y creación escénica contemporánea. Formado en canto e interpretación en centros superiores de referencia, es Máster en Interpretación Operística por el Conservatorio Superior Joaquín Rodrigo (Valencia) y titulado superior en Canto por la Escuela Superior de Canto de Madrid.\n\nHa actuado en escenarios como el Teatro Real, el Teatro Circo Price, el Teatro de la Zarzuela, Teatros del Canal, Palau de Les Arts, Ópera de Tenerife y Ópera de Oviedo, participando en producciones de ópera, zarzuela y teatro musical, así como en proyectos de performance y creación interdisciplinar.\n\nSu repertorio incluye títulos como La flauta mágica, Lucrezia Borgia, Manon Lescaut o Il mondo della luna, combinando el trabajo lírico con una intensa actividad en formatos contemporáneos y musicales. Ha sido protagonista en producciones del Teatro Circo Price y ha desarrollado parte de su carrera internacionalmente como cantante y performer en giras con Norwegian Cruise Line por África, Asia y el Mediterráneo.\n\nDestaca por su versatilidad vocal, fuerte presencia escénica y sensibilidad interpretativa, cualidades que le permiten moverse con naturalidad entre el repertorio clásico y el lenguaje del classical crossover."
        }
      },
  ...
  en: {
    ...
    tenors: {
      ...
      profiles: {
        ...
        mario: {
          voice: "Light Tenor",
          bio: "Mario Méndez Saavedra is a singer and actor, with a solid career in opera, zarzuela, musical theater and contemporary scenic creation. Trained in singing and acting at reference higher centers, he holds a Master's degree in Operatic Interpretation from the Joaquín Rodrigo Higher Conservatory (Valencia) and a higher degree in Singing from the Madrid Higher School of Singing.\n\nHe has performed on stages such as the Teatro Real, Teatro Circo Price, Teatro de la Zarzuela, Teatros del Canal, Palau de Les Arts, Ópera de Tenerife and Ópera de Oviedo, participating in opera, zarzuela and musical theater productions, as well as in performance and interdisciplinary creation projects.\n\nHis repertoire includes titles such as The Magic Flute, Lucrezia Borgia, Manon Lescaut or Il mondo della luna, combining lyrical work with intense activity in contemporary and musical formats. He has been a protagonist in productions at the Teatro Circo Price and has developed part of his career internationally as a singer and performer on tours with Norwegian Cruise Line through Africa, Asia and the Mediterranean.\n\nHe stands out for his vocal versatility, strong stage presence and interpretive sensitivity, qualities that allow him to move naturally between the classical repertoire and the language of classical crossover."
        }
      },
